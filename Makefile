...
release:
	g++ main.cpp -o main.o -c -Wall -Wshadow -O2
	nasm -f elf64 test1.asm -o test1.o
	nasm -f elf64 test2.asm -o test2.o
	nasm -f elf64 test3.asm -o test3.o
	nasm -f elf64 test4.asm -o test4.o
	g++ main.o test1.o test2.o test3.o test4.o -o test -O2
